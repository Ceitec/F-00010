...
/******************************************************/
//variables
volatile struct TB_PARAM TB_param;
volatile struct TB_GBPARAM TB_gbparam;
volatile struct TB_IO TB_inp;
volatile struct TB_IO TB_out;
